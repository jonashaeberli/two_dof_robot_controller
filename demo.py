...
if pnp.controller.setup_controller():
    ...
    pnp.controller.moveL(500, 80, max_linear_velocity=1000, max_linear_acceleration=4500)
    ...
    pnp.controller.moveL(150, 80, max_linear_velocity=1000, max_linear_acceleration=4500)
